...
def main(**kwargs):
    ...
    quoteOutput = kwargs.pop('quoteOutput', False)

    if quoteOutput is False:
    ...
    writer = csv.DictWriter(fout, delimiter = delimiter, fieldnames = output_fieldnames, quoting = quoting)
    writer.writeheader()
...
def parse():
    ...
    parser.add_argument("--quoteOutput", action='store_true', dest = 'quoteOutput', help="Quoting for output fields")
